...
namespace UI.UniTest
{
    ...
    public partial class UniTestflow : System.Windows.Window
    {
        ...
        private CoreParameter _coreParameter;
        private bool Simaulation;

        public UniTestflow(CoreParameter coreParameter)
        {
            InitializeComponent();
            _coreParameter = new CoreParameter();
            Simaulation = _coreParameter.ini.ReadIni("Simulation", "DB") == "1" ? true : false;
        }


        private void CasualTestRun(object sender, RoutedEventArgs e)
        {
            ////var test = new Result(_coreParameter);
