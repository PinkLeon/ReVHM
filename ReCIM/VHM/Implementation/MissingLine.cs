...
namespace VHM.Implementation
{
    public class MissingLine : FrontMeasurement
    {
        ...
        public async override Task<Result> Do(HObject hObject, AOICore Data)
        {
            ...
            //降影像解析度 要丟原圖
            HOperatorSet.ZoomImageFactor(hObject, out HObject ho_Image, Data.ZoomFactor, Data.ZoomFactor, "constant");

            //計算格線寬、高的Pixel
            CalculateGridPixel(Data.GridWidth, Data.GridHeight, Data.PixelSize, Data.ZoomFactor, out HTuple hv_GridWidthPixel, out HTuple hv_GridHeightPixel);
            ...
            {
                await Global.WriteLog("HALCON", "MissingLine Error", ex.Message + ex.StackTrace);
            ...
            //根據公差做篩選
            FilterResult(Regions, out HObject ZoomRegion, Data.ToleranceType, Values, Data.Tolerance, out DefectValues);
            ...
            {
                //輸出最大與最小NG區域影像
                FilterMinMaxResult(ho_Image, Regions, ZoomRegion, out HObject ho_MinDefectImage, out HObject ho_MaxDefectImage, out ZoomRegion, Data.ToleranceType, Values, Data.Tolerance);
