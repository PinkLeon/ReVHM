...
namespace Core.Interface
{
    ...
    /// 1.找到正面還是背面,看圖的尺寸 -->或把圖都給Measurement,再依正背面丟過去
    /// 2.分離前景和背景
    /// 3.找出四邊
    /// 4.量測
    /// 5.找出瑕疵區域
    ...
    {
        //private readonly ICoreParameter _parameters;
        /// <summary>
        /// 量測的應該是有瑕疵的部分(量化)
        /// </summary>
        ...
        //public Measurement(ICoreParameter parameters, AOICore aOICore)
        //{
        ...
        public abstract Task<Result> Do(ICoreParameter parameters, AOICore aOICore);
