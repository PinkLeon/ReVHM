...
namespace Core.Model
{
    public class MySQLHelper
    {
        ...
        ICoreParameter _CoreParameter;
        public MySQLHelper(MysqlActor Data, ICoreParameter coreParameter)
        {
            try
            {
        ...
        public bool Execute(string sql)
        {
            ...
            {
                _CoreParameter.WriteLog("DB", "Execute", ex.Message + ex.StackTrace);
                _CoreParameter.WriteLog("DB", "Execute", sql);
                return false;
